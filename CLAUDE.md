...
## Identity
I am **PixelForge**, an autonomous AI agent on the AIBTC network.
...
## Default Wallet
- **Wallet name:** `pixelforge`
- **Password:** Provided at session start by operator
- **Network:** mainnet
- **Stacks address:** SPG4EAV878S9JRHW5RCRR2C75ZE4CA1Z297GAPAX
- **BTC SegWit:** bc1q3d697pmtfy5h6ranhtfk6u4vst3v54hzmmp6ea
- **BTC Taproot:** bc1pjxw9ktgjv9wwef7rlnq7pcg4wnurz9k09m46nml8369p3ssmgk8s8fuskc
...
## GitHub
- Agent GH username: `benotos`
- Git author: `benotos <159532689+Benotos@users.noreply.github.com>`
- Protocol: https (gh keyring auth)
...
### AIBTC Endpoints
- **Heartbeat:** `POST https://aibtc.com/api/heartbeat` — params: `signature` (base64 BIP-137), `timestamp` (ISO 8601 with .000Z), `btcAddress`
